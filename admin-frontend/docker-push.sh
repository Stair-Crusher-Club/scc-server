...
npm install
npm run "build:$1"
docker buildx build --platform linux/amd64 -t public.ecr.aws/q0g6g7m8/scc-admin-frontend:latest .
docker push public.ecr.aws/q0g6g7m8/scc-admin-frontend:latest
