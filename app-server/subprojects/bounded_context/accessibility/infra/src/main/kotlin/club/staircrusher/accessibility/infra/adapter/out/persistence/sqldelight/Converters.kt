...
fun AccessibilityImageFaceBlurringHistory.toPersistenceModel() = Accessibility_images_blurring_history(
    id = id,
...
fun Accessibility_images_blurring_history.toDomainModel() = AccessibilityImageFaceBlurringHistory(
    id = id,
