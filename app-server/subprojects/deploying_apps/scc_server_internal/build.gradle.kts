...
jib {
    ...
    to {
        image = "public.ecr.aws/i6n1n6v2/scc-server-internal"
    ...
    container {
        ...
        environment = mapOf(
            "JAVA_MAIN_CLASS" to "club.staircrusher.scc_server.SccServerInternalApplicationKt",
            "JAVA_LIB_DIR" to "/app/libs/*:/app/classes:/app/resources",
        )
        mainClass = "club.staircrusher.scc_server.SccServerInternalApplicationKt"
